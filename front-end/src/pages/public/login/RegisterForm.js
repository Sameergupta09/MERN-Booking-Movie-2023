...
function RegisterForm() {
  ...
  const validate = (values) => {
    ...
    if (!values.name) {
      ...
      errors.name = "! The name must be at least 6 characters long";
    ...
    if (values.passwordConfirm !== values.password) {
      errors.passwordConfirm = "! Password does not match the one entered";
    }
    return errors;
  }    
  // HOOK
        ...
        return (
          ...
          >
            ...
            >
              ...
              Register online on multiple platforms
              </h1>
