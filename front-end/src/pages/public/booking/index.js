              ...
              <div className="lg:px-14 md:px-12 px-6 md:py-16 py-14 lg:py-20 min-h-screen max-h-full bg-transparent">
                <Breadcrumbs className="bg-transparen p-0">
                  <Link to="/home" className="text-gray-400">
                    {content === "" ? "Home" : content.booking.linkHome}
                  </Link>
                  <Link to="/booking" className="text-gray-200">
                    {content === "" ? "Book Movie Tickets" : content.booking.link}
                  </Link>
                </Breadcrumbs>
                <div className="flex justify-between">
                  ...
                  >
                    {content === "" ? "Home" : content.booking.titleMovie}
                  </button>
                </div>
                  ...
                  {valueMovie !== "" &&
                    ...
                    valueShowTime.id !== "" && (
                      <>
                        ...
                        >
                          {content === ""
                            ? "Select Ticket Type & Package Options"
                              ...
                              <div className="px-5 py-10">
                                <div>
                                  ...
                                  <p className="py-1 mt-2 text-red-500 text-[17px]">
                                    ...
                                    {vlPriceFood + vlPriceTicket}.000 VND
                                  </p>
                                  <p className="text-[10px] text-gray-200">
                                    (If you don’t want to sit on the roof, please choose a seat.)
                                  </p>
                                  ...
                                  {stateLoadingLogin.loading === true ? (
                                    ...
                                    <div>
                                      {newSelectSeats.length > 0 ? (
                                        ...
                                        <Tooltip content="Choose Tickets and Seats to Continue">
