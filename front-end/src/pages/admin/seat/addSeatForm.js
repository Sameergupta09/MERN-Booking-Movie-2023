...
function SeatForm() {
  ...
  const handleUpdateNewSeat = useCallback((seatId, values) => {
    ...
    toast.success("Seat list reset successful!", {
  ...
  const submitForm = async (values, { resetForm }) => {
    ...
    toast.success("Added seat list to screening room!", {
      position: toast.POSITION.BOTTOM_LEFT,
      className: "text-black",
    });
    resetForm();
        ...
        return (
          ...
          <div className="grid grid-cols-10 gap-x-3 rounded-lg mt-5">
            <form className="px-10 py-3 col-span-7 shadow-2xl" onSubmit={handleSubmit}>
              ...
              <div className="mb-3 ">
                ...
                >
                  ...
                  <option value="Screening room 1">Screening room 1</option>
                  <option value="Screening room 2">Screening room 2</option>
                </select>
              </div>
              <div className="mb-3 ">
                <label
            ...
            >
              ...
              <DialogBody divider>
                <p className="text-black">Entrance</p>
                {seats.map((seats) => (
                  <div key={seats._id}>
