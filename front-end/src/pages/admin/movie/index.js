...
function ManageMovie() {
  ...
  const handleDeleteMovie = () => {
    ...
    toast.success("Deleted 1 movie that was playing!", {
  ...
  const handleDeleteMovieSoon = () => {
    ...
    toast.success("Deleted 1 upcoming movie!", {
      position: toast.POSITION.BOTTOM_LEFT,
      className: "text-black",
    });
  };
      ...
      <div>
        <div className="grid grid-cols-10">
          ...
          <div className="col-span-8">
            ...
            <div className="m-5">
              <h1 className="font-bold text-[35px] uppercase">Movie Management</h1>
              <div className="flex justify-start mt-5">
                <div className="rounded-lg shadow-2xl text-center mr-2 p-3">
                  <h1>MOVIE NOW SHOWING</h1>
              ...
              <div className="mt-5 px-2 py-4 rounded-lg shadow-xl">
                <div className="flex justify-between">
                  <h2 className="py-2 font-medium">List of movies showing now</h2>
              ...
              >
                <DialogHeader>
                  ...
                  DELETE 1 MOVIE THAT IS SHOWING
                  </h2>
                </DialogHeader>
                <DialogBody divider>
              ...
              {/* PHIM SẮP CHIẾU */}
              <div className="mt-5 px-2 py-4 rounded-lg shadow-xl">
                <h2 className="py-3 font-medium">List of upcoming movies</h2>
                <div className="mt-3 shadow-2xl">
                  <div className="overflow-x-auto">
                    <div className="w-full inline-block align-middle">
                      <div className="overflow-auto rounded-xl">
